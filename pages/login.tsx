  ...
  return (
    <Container>
      <CenterBox flexDirection="column">
        ...
        <Form>
          <Box mb="1rem">
            <Input type="email" placeholder="Email" appearance="default" autoComplete="on" required />
          </Box>
          <Box mb="1rem">
            <Input type="password" placeholder="Password" appearance="default" autoComplete="on" required />
          </Box>
